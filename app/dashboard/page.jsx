  ...
  if (key.includes("java")) {
    return (
      <svg viewBox="0 0 64 64" className="h-11 w-11" fill="none">
        ...
        <path
          d="M22 38h20M24 44h16"
          stroke="#7c2d12"
          strokeWidth="3.5"
          strokeLinecap="round"
        />
        <path
          d="M32 18c5 3-2 6 3 9s-3 6 2 9"
          stroke="#dc2626"
          strokeWidth="3"
          strokeLinecap="round"
        />
  ...
  if (key.includes("kubernetes")) {
    return (
      <svg viewBox="0 0 64 64" className="h-11 w-11" fill="none">
        ...
        <path
          d="M32 16v10M32 38v10M16 32h10M38 32h10M21 21l7 7M36 36l7 7M43 21l-7 7M28 36l-7 7"
          stroke="#1d4ed8"
          strokeWidth="3"
          strokeLinecap="round"
        />
  ...
  if (key.includes("system")) {
    return (
      <svg viewBox="0 0 64 64" className="h-11 w-11" fill="none">
        ...
        <path
          d="M30 24h4M24 30v4M40 30v4M32 30v4"
          stroke="#e0e7ff"
          strokeWidth="2.5"
          strokeLinecap="round"
        />
